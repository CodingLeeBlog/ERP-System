							...
							<div class="row mb-2">
								<div class="col-xl-8">
									...
									<div class="mb-3 col-md-6">
										<label class="form-label">날짜로 검색</label> <input type="date"
											class="form-control date" id="singledaterange"
															...
															<tr class="text-left">
																...
																<td>
																	<button type="button" id="insertBtn"
																		...
																		data-bs-target="#exampleModalFullscreenSm">등록</button>
																</td>
															</tr>
														</c:forEach>
													</c:otherwise>
